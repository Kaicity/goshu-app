...
import { UserAccountDto, UserAccountFilterDto, UserAccountPaginationDto } from '@/models/dto/userAccountDto';
...
export const getUsers = async (page: number, limit: number, filters: UserAccountFilterDto): Promise<UserAccountPaginationDto> => {
  try {
...
export const updateAccountUser = async (id: string, user: UserAccountDto): Promise<any> => {
  try {
...
export const changePasswordUser = async (email: string, password: string): Promise<any> => {
  try {
